...
export async function GET() {
  ...
  const fields = 'id,title,employmentType,customFloat1,address(city,state,zip),clientCorporation(id,name),publicDescription,publishedCategory(id,name),salary,salaryUnit,dateAdded,dateLastPublished,customFloat2'
